...
class WPMeetupEventListWidget extends NMWidget {
	...
	public function form($instance) {
		...
		<p><label for="<?php echo $this->get_field_id('max_events'); ?>"><?php _e('Maximun events shown:'); ?></label>
			<input class="widefat" id="<?php echo $this->get_field_id('max_events'); ?>" name="<?php echo $this->get_field_name('max_events'); ?>" type="number" value="<?php echo esc_attr($max_events); ?>"/>
		</p>
		<?php
