...
class WPMeetupCalendarWidget extends NMWidget {
	...
	public function form($instance) {
		...
		<p><label for="<?php echo $this->get_field_id('widget_legend'); ?>"><?php _e('Display Legend:'); ?></label>
			<input class="widefat" id="<?php echo $this->get_field_id('widget_legend'); ?>" name="<?php echo $this->get_field_name('widget_legend'); ?>" type="checkbox" value="checked"<?php echo esc_attr($legend); ?> />
		</p>
		<?php
