...
For more information, visit the plugin homepage at [Nuanced Media](https://nuancedmedia.com/wordpress-meetup-plugin/).

About Nuanced Media:
Nuanced Media specialized in [Web Design](https://nuancedmedia.com/tucson-website-design/), [Marketing](https://nuancedmedia.com/internet-marketing-tucson-az/) & [Brand](https://nuancedmedia.com/brand-tucson-az/) development. We takes pride in our hard work and dedication to drive more consumers towards client webpage. Through social media marketing, search engine optimization, and personalized web design the Nuanced Team ensures professional products.
...
= 2.3.0 =
* Updated authentication method to OAuth2 to accommodate Meetup.com's API key deprecation
* Updated API methods from API v2 to API v3 to accommodate Meetup.com's API v2 deprecation
